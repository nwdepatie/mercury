...
#
# Generated by Vivado on Sat Feb 10 21:13:55 EST 2024
...
#
#    "/home/nwdepatie/mercury/mercury-hdl/mercury/mercury.srcs/utils_1/imports/synth_1/mercury_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/nwdepatie/mercury/mercury-hdl/microzed_7z020_master_XDC_commented_RevB_v1.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/mercury/mercury.srcs/utils_1/imports/synth_1/mercury_wrapper.dcp"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/microzed_7z020_master_XDC_commented_RevB_v1.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "[file normalize "$origin_dir/microzed_7z020_master_XDC_commented_RevB_v1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/microzed_7z020_master_XDC_commented_RevB_v1.xdc"
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/microzed_7z020_master_XDC_commented_RevB_v1.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/microzed_7z020_master_XDC_commented_RevB_v1.xdc"]" -objects $obj
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.67884",
   "Default View_TopLeft":"-57,4",
...
preplace port port-id_JX2_LVDS_13_P -pg 1 -lvl 4 -x 1080 -y 490 -defaultsOSRD
preplace port port-id_JX2_LVDS_13_N -pg 1 -lvl 4 -x 1080 -y 240 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y 440 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 240 -y 700 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -x 630 -y 170 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 3 -x 930 -y 480 -defaultsOSRD
preplace inst axi_timer_1 -pg 1 -lvl 3 -x 930 -y 230 -defaultsOSRD
preplace netloc axi_timer_0_pwm0 1 3 1 NJ 490
preplace netloc axi_timer_1_pwm0 1 3 1 NJ 240
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 590 470 360 790
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 600 450
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 480 340 800
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 780 160n
preplace netloc axi_interconnect_0_M01_AXI 1 2 1 N 180
...
preplace netloc processing_system7_0_M_AXI_GP1 1 1 1 460 80n
levelinfo -pg 1 0 240 630 930 1080
pagesize -pg 1 -db -bbox -sgen 0 0 1240 800
"
}
