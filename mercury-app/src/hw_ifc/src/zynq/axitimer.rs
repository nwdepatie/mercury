...
impl AXITimer {
    ...
    pub fn start_pwm(&mut self, period: u32, duty_cycle: u32) {
        self.mapped_mem.write_u32(
            TCSR0_OFFSET,
            self.mapped_mem.read_u32(TCSR0_OFFSET)
                | TCSR_PWM_ENABLE
                | TSCR_GENT1
                | TSCR_UDT1
                | TSCR_ARHT1
        ...
        self.mapped_mem.write_u32(
            TCSR1_OFFSET,
            self.mapped_mem.read_u32(TCSR1_OFFSET)
                | TCSR_PWM_ENABLE
                | TSCR_GENT1
                | TSCR_UDT1
                | TSCR_ARHT1
        ...
        self.mapped_mem.write_u32(
            TCSR0_OFFSET,
            self.mapped_mem.read_u32(TCSR0_OFFSET) | TSCR_ENALL,
        );
